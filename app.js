...
app.post('/login', (req, res) => {
    ...
    db.get(query, function (err, row) {
        if (err) {
            ...
            res.send('Hello <b>' + row.title + '!</b><br /><br /> This page contains all your secret data: <br /><br />SECRETS <br /><br /> MORE SECRETS <br /><br /><a href="/index.html">Go back to login</a>');
        }
    });
});
